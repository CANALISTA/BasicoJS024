...
class Persona2 {
    ...
    get nombreCompleto(){this._nombre+ ' '+ this.apellido}; 
}
...
this._edad= edad; 
    ...
    set apellido(parm){this._apellido=parm;}

    get edad(){return this._edad;}

    set edad(pem){this._edad=pem;}
}
...
class Empleado extends Persona4{
    ...
    get departamento(){return this._departamento=this.departamento;}

    set departamento(ls){this._departamento=ls; }
...
class Empleado2 extends Persona4{
    ...
    get depto(){return this._deptp;}

    set depto(dp){this._deptp=dp;}
}
